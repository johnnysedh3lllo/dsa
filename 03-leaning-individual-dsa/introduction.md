# 03. Learning individual data structures and algorithms
...
Here's the regenerated courses table:

### Courses

| Resource                                                                                                                            |  Duration   |      Effort      |                                                     Alt link                                                      |    Level     | Prerequisites                                                                                                                                                                 |
| :---------------------------------------------------------------------------------------------------------------------------------- | :---------: | :--------------: | :---------------------------------------------------------------------------------------------------------------: | :----------: | :---------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [CS50's Introduction to Computer Science (Harvard)](https://cs50.harvard.edu/x)                                                     |  12 weeks   | 10-20 hours/week | [Edx Link](https://www.edx.org/learn/computer-science/harvard-university-cs50-s-introduction-to-computer-science) |   Beginner   | **No programming experience required**                                                                                                                                            |
| [Algorithms I (Princeton, Coursera)](https://www.coursera.org/learn/algorithms-part1)                                               |  54 hours   |        -         |                                                         -                                                         | Intermediate | **Java** basics (loops, arrays, functions), Basic **discrete mathematics** (proofs, induction), Basic **data structures** (arrays, lists)                                     |
| [Stanford's Algorithms Specialization (Coursera)](https://www.coursera.org/specializations/algorithms)                              |   1 month   |  10 hours/week   |                                                         -                                                         | Intermediate | Programming experience in any language, **Linear algebra** (matrices, vectors), Basic **probability & combinatorics**, Basic **graph theory**                                 |
| [Algorithms II (Princeton, Coursera)](https://www.coursera.org/learn/algorithms-part2)                                              |  62 hours   |        -         |                                                         -                                                         |   Advanced   | **Algorithms I**, **Advanced Java** (Collections Framework), **Strong knowledge** of **hash tables, BSTs, priority queues**.                                                  |
| [MIT's OpenCourseWare: Introduction to Algorithms (6.006)](https://ocw.mit.edu/courses/6-006-introduction-to-algorithms-fall-2011/) | 20-22 hours |        -         |           [Youtube Playlist](https://www.youtube.com/playlist?list=PLUl4u3cNGP61Oq3tWYp6V_F-5jb5L2iHb)            |   Advanced   | Proficiency in **Python 3** or **C++** (OOP concepts), Strong **discrete mathematics** background, **Linear algebra** fundamentals, Experience with basic **data structures** |
